    ...
    <>
      <Box width='100%' className={'card-3'} ref={ref} minHeight='80vh' display='relative'  >
        <motion.div
          ...
          data-tooltip-id='my-tooltip-inline' data-tooltip-content=' E-commerce App '
          className='project-3' >
          <div className="project-text-3">
            <TypographyMotion initial={{ opacity: 0, x: -100 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 0.6 }} fontFamily='roboto' fontWeight='500' variant='h5'> E-commerce App </TypographyMotion>
